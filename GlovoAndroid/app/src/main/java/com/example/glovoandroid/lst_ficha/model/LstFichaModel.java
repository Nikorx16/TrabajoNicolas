package com.example.glovoandroid.lst_ficha.model;
...
public class LstFichaModel implements LstFichaContract.Model {
    @Override
    public void lstRestaurantWS(String nombre, onLstRestaurantListener onLstRestaurantListener) {
       ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
       Call<ArrayList<Restaurante>> call = apiService.getFichaRestaurante(nombre);
