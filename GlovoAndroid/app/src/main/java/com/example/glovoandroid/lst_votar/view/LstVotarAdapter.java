...
import java.util.ArrayList;
    ...
    public class LstVotarAdapter extends RecyclerView.Adapter<LstVotarAdapter.ViewHolder> {
    private ArrayList<Restaurante> dataset;
    private Context mContext;

    public LstVotarAdapter(Context mContext, ArrayList<Restaurante> lstRestaurantes){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_restaurant_votar,parent,false);
